...
Current version: [1.1.1](https://github.com/bunsenbrowser/bunsen/releases/tag/1.1.1). We're on [Play store](https://play.google.com/store/apps/details?id=org.bunsenbrowser) or use the direct download from [GitHub](https://github.com/bunsenbrowser/bunsen/releases/download/1.1.1/bunsen.apk) 
